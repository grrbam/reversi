...
/* If we're notified that we joined the room, then ignore it */
...
/* If we're notified that we left the room, then ignore it */
  if(payload.socket_id == socket.id){
    return;
  }
  ...
  for(row = 0; row < 8; row++){
    for(column = 0; column < 8; column++){
      ...
      if(old_board[row][column] != board [row][column]){
        if(old_board[row][column] == '?' && board[row][column] == ' '){
          $('#'+row+'_'+column).html('<img src="yass-images/reversi_pug_empty.gif" alt="empty square"/>');
        }
        else if(old_board[row][column] == '?' && board[row][column] == 'w'){
          $('#'+row+'_'+column).html('<img src="yass-images/reversi_pug_e2w.gif" alt="white square"/>');
        }
        else if(old_board[row][column] == '?' && board[row][column] == 'b'){
          $('#'+row+'_'+column).html('<img src="yass-images/reversi_pug_e2b.gif" alt="black square"/>');
        }
        else if(old_board[row][column] == ' ' && board[row][column] == 'w'){
          $('#'+row+'_'+column).html('<img src="yass-images/reversi_pug_e2w.gif" alt="white square"/>');
        }
          ...
          $('#'+row+'_'+column).html('<img src="yass-images/reversi_pug_w2e.gif" alt="empty square"/>');
        }
        else if(old_board[row][column] == 'b' && board[row][column] == ' '){
          $('#'+row+'_'+column).html('<img src="yass-images/reversi_pug_w2b.gif" alt="empty square"/>');
        }
        else if(old_board[row][column] == 'w' && board[row][column] == 'b'){
          $('#'+row+'_'+column).html('<img src="yass-images/reversi_pug_w2b.gif" alt="black square"/>');
        }
        else if(old_board[row][column] == 'b' && board[row][column] == 'w'){
          $('#'+row+'_'+column).html('<img src="yass-images/reversi_pug_b2w.gif" alt="white square"/>');
        }
        else{
          $('#'+row+'_'+column).html('<img src="yass-images/reversi_pug_error" alt="error"/>');
        }
      }
